        ...
        <div className="group bg-gradient-to-r from-[#d6001c] via-[#e60023] to-[#b30018] rounded-2xl sm:rounded-3xl py-6 sm:py-7 md:py-8 px-6 sm:px-10 md:px-14 shadow-[0_20px_50px_rgba(214,0,28,0.35)] flex flex-col md:flex-row items-center justify-between gap-6 text-white transition-all duration-500 hover:shadow-[0_25px_60px_rgba(214,0,28,0.45)]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-center sm:text-left">
            ...
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-full flex items-center justify-center shrink-0 shadow-md transform transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
              <PhoneCall className="w-6 h-6 sm:w-7 sm:h-7 text-[#d6001c]" />
            </div>

            {/* Text */}
            <div className="flex flex-col">
              <h3 className="font-serif text-2xl sm:text-3xl lg:text-[2.1rem] font-normal text-white leading-tight mb-1 drop-shadow-sm">
                Have Questions?
              </h3>
          ...
          <div className="w-full sm:w-auto">
            <a
              ...
              className="inline-flex items-center justify-center bg-white hover:bg-gray-50 text-gray-900 px-9 sm:px-11 py-3.5 sm:py-4 rounded-xl font-bold text-xs sm:text-[13px] tracking-wider uppercase transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 whitespace-nowrap w-full sm:w-auto min-h-[48px]"
            >
              CONTACT US
            </a>
          </div>
