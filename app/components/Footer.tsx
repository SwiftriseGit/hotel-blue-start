...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#141414] text-white pt-16 sm:pt-18 pb-6 overflow-hidden">
      <div className="max-w-[1140px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 pb-8">
            ...
            <div className="flex flex-col items-start">
              ...
              <a href="#" className="flex items-center gap-2.5 mb-3 group">
                <Star className="w-6 h-6 sm:w-7 sm:h-7 fill-[#b30018] text-[#b30018] shrink-0 transition-transform duration-300 group-hover:rotate-12" />
                <div className="flex flex-col leading-tight">
                  <span className="text-[11px] font-bold tracking-[0.2em] text-white">
                    HOTEL
                  </span>
                  <span className="text-[15px] sm:text-[16px] font-bold tracking-[0.15em] text-white">
                    SILVER STAR
                  </span>
                </div>
              </a>

              <p className="text-gray-400 text-[12px] leading-relaxed max-w-xs mb-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a
                  href="#"
                  aria-label="Facebook"
                  className="w-9 h-9 rounded-full bg-white/5 border border-white/10 hover:border-[#b30018] hover:text-[#b30018] hover:-translate-y-0.5 hover:shadow-md hover:shadow-red-800/30 flex items-center justify-center text-gray-300 transition-all duration-300 min-w-[36px] min-h-[36px]"
                >
            ...
            {/* Col 2: Quick Links */}
            <div>
              <h4 className="text-[12px] font-bold tracking-[0.14em] text-white uppercase mb-2.5">
                QUICK LINKS
              </h4>
              <ul className="flex flex-col gap-1.5 text-[13px] text-gray-400">
                <li>
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-gray-400 text-[12px] leading-relaxed mb-2.5">
              ...
              <div className="flex items-center gap-2 text-[12px] text-gray-300 mb-3.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-[#b30018] hover:bg-[#990012] text-white px-6 py-2 rounded-lg font-bold text-xs tracking-[0.14em] uppercase transition-all duration-300 shadow-md hover:shadow-red-800/40 hover:-translate-y-0.5 active:translate-y-0 min-h-[38px]"
              >
                BOOK NOW
              </a>
            </div>
        ...
        <div className="border-t border-white/10 pt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          ...
          <button
            ...
            className="w-8 h-8 bg-white/10 hover:bg-[#b30018] text-white rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer min-w-[32px] min-h-[32px]"
          >
