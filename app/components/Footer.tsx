      ...
      <div className="max-w-[1140px] mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <button
            ...
            className="w-9 h-9 bg-white/10 hover:bg-[#b30018] text-white rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer min-w-[36px] min-h-[36px]"
          >
